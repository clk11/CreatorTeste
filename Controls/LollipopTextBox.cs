...
public class LollipopTextBox : Control
{
    ...
    //[Category("Custom")]
    //[Browsable(true)]
    //[Description("This property is helps you to change the size of the textBox .")]
    //public Font TextBoxSize { get; set; }
    ...
    public void AddTextBox()
    {
        ...
        LollipopTB.Font = new Font("Arial", 11.11F, FontStyle.Regular, GraphicsUnit.Point, 0);
        LollipopTB.UseSystemPasswordChar = UseSystemPasswordChar;
